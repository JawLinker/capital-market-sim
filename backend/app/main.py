...
from .routers import advisor, auth, bots, chronicle, decisions, duels, earnings, gamification, game, legends, margin, news, orders, players, portfolio, predictions, quests, replay, stocks, stories, storylines, trades
