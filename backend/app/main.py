...
from .routers import advisor, auth, bots, chronicle, duels, earnings, gamification, game, legends, news, orders, players, portfolio, quests, replay, stocks, stories, storylines, trades
